...
// create component using class (Class-Based Component) and give access to all functionality that React.Component has.
...
class SearchBar extends Component {
  ...
  render() {
    ...
    // Setting our Input element as a Controlled Component by setting its value as state.
